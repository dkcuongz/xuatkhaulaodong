...
@section('title', 'Chỉnh sửa bài viết thiết kế')

@section('content_header')
    <h1 class="m-0 text-dark">Chỉnh sửa bài viết thiết kế</h1>
@stop
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            @foreach ($categories as $subcategory)
                                <!-- Include categories.blade.php file and pass the current category to it -->
                                    @include('admin.categories.categories', ['parent_id'=>0,'category' => $subcategory, $level='', 'selected' => $post->category_id])
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="col-md-12 mb-2 @if (count($post->images) > 0) {{'d-none'}} @endif"
                             id="none-image">
                        ...
                        <div class="list-images">
                            @if (isset($post->images) && !empty($post->images))
                                @foreach (json_decode($post->images) as $key => $img)
                                    <div class="box-image">
