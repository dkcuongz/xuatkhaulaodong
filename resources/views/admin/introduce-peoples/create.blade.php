...
@section('title', 'Tạo mới giới thiệu con người')

@section('content_header')
    <h1 class="m-0 text-dark">Tạo mới giới thiệu con người</h1>
@stop

@section('content')
    <form action="{{route('admin.introduce-peoples.store')}}" method="post" enctype="multipart/form-data" id="upload-image">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{route('admin.introduce-peoples.index')}}" class="btn btn-default">
                            Danh sách giới thiệu con người
                        </a>
                    </div>
                </div>
            </div>
