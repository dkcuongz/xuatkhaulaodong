...
@section('content')
    <form action="{{route('admin.introduces.update', $introduce)}}" method="post" enctype="multipart/form-data"
          id="upload-image">
        @method('PUT')
        @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="summernote form-control @error('description') is-invalid @enderror"
                                      ...
                                      name="description">{{old('description') ?? $introduce->description}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="status"
                                       {{ $introduce->status == '1' ? 'checked' : '' }} id="status" value="1">
